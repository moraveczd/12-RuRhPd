...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \ce{^{96}Ru}; 5,54~\%
			\item \ce{^{98}Ru}; 1,87~\%
			\item \ce{^{99}Ru}; 12,76~\% -- využívá se v NMR spektroskopii\footnote[frame]{\href{https://doi.org/10.1021/om990477n}{$^{99}$Ru NMR Spectroscopy of Organometallic and Coordination Complexes of Ruthenium(II)}}
