...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \ce{^{96}Ru}; 5,54~\%
			\item \ce{^{98}Ru}; 1,87~\%
			\item \ce{^{99}Ru}; 12,76~\% -- využívá se v NMR spektroskopii\footnote[frame]{\href{http://triton.iqfr.csic.es/guide/eNMR/chem/Ru.html}{Ruthenium NMR}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Hexachloropalladnaté komplexy, \ce{[PdCl6]^{2-}}, lze získat rozpouštěním palladia v lučavce královské.
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.85\textwidth]{img/Alpha-PdCl2.png}
		\caption*{Krystalová struktura \ce{\alpha-PdCl2}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Rh_price.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Lze ho získat i z vyhořelého jaderného paliva.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{column}{.4\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.3\textheight]{img/DodgeCatCon.jpg}
		\end{figure}
	\end{column}
	\begin{column}{.6\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.3\textheight]{img/Katalysator_fur_Auto.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Monsanto-Prozess.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/Acetylenedicarboxylic_acid_lindlar.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/KumadaSchSimplifiedNoEngl.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Kumada_Catalytic_Cycle.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.8\textwidth]{img/HerrmannCat.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Heck_Reaction_Mechanism.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/MLCC-BME-NME-engl.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item U nestechiometrických fází byla také pozorovány vysokoteplotní supravodivost (až 273~K)\footnote[frame]{\href{https://doi.org/10.1016/S0921-4534(02)02745-4}{Possibility of high temperature superconducting phases in PdH}} za nízkého tlaku (na rozdíl od hydridů lanthanu).
		...
		\item Při vzniku fáze $\alpha$ dochází jen k malých objemovým změnám, nárust objemu při vzniku $\beta$ fáze je až 10~\%.
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Hydrogen.economy.sys_integration_circle.jpg}
	\end{figure}
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Fuel_Cell_Block_Diagram.png}
	\end{figure}
}
...
\frame{
	\frametitle{}
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/PEM_fuelcell.png}
	\end{figure}
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Rivaz_Engine.jpg}
				\caption*{Vodíkový motor z roku 1806}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Mazda_RX-8_hydrogen}
				\caption*{Mazda RX-8 Hydrogen}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Oxidací chloridu ruthenitého získáme oxid rutheničitý, \ce{RuO2}. Krystaluje ve struktuře rutilu.
		\item Ten lze dále oxidovat jodistanem až na \ce{RuO4}.
		\item Monokrystaly \ce{RuO2} lze připravit také pomocí CVD těkavých sloučenin ruthenia, jako transportní médium slouží kyslík.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/RuO2.png}
		\caption*{Základní buňka \ce{RuO2}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/RuO4-degradation-rev.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Ruthenistany i ruthenanu jsou silná oxidační činidla, ale ve vhodném pH jsou stabilní i ve vodných roztocích.
...
\frame{
	...
	\begin{tabular}{|l|l|l|l|}
		...
		žlutý & & & \\\hline
		\hline
		\ce{RuF5}\footnote[frame]{\href{https://doi.org/10.1039/JR9640000644}{The crystal structure of ruthenium pentafluoride}} &  & & \\\hline
		tmavě zelený & & & \\\hline
		\hline
		\ce{RuF6} & & & \\\hline
		tmavě hnědý & & & \\\hline
	\end{tabular}
	\begin{figure}
		\adjincludegraphics[height=.2\textheight]{img/RuF5.png}
		\caption*{\ce{RuF5} vytváří tetramerní molekuly \ce{Ru4F20}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Rh2S3.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{tabular}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/RuF5.png}
		\caption*{\ce{RhF5} vytváří tetramerní molekuly \ce{Rh4F20}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.45\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Hexadecacarbonylhexarhodium.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Reakcí s dusičnanu palladnatého s alkalickými hydroxidy dochází ke srážení žlutého hydratovaného oxidu.
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Pd-PdF6.png}
		\caption*{Krystalová struktura \ce{Pd[PdF6]}}
	\end{figure}
	\vfill
}
