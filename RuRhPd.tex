	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				...
				\caption*{Zelený \ce{RuF5} vytváří tetramerní molekuly \ce{Ru4F20}.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:PtF5solid.tif}{Smokefoot/Commons}}}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
	...
	\begin{columns}
		...
		\begin{column}{.6\textwidth}
			\begin{itemize}
				...
				\item V krystalickém stavu vytváří polymery, oktaedry \ce{RuF6} sdílejí vrchol.
			\end{itemize}
		\end{column}
	\end{columns}
	\vfill
