...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.45\textheight]{img/RuO2.png}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				...
				\caption*{\ce{RuF5} vytváří tetramerní molekuly \ce{Ru4F20}.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:PtF5solid.tif}{Smokefoot/Commons}}}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
